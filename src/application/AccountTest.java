...
public class AccountTest {
	...
	void testPasswordRequirement() {
		...
		assertTrue("The password is at least 8 characters.", Account.passwordRequirement("abcdfgh1"));			// 8 characters long, pass
	...
	void testUsernameRequirement() {
		...
		assertTrue("The username is at least 6 characters.", Account.usernameRequirement("abcdfg"));		// 6 characters long, pass
