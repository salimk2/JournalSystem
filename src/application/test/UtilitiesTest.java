...
class UtilitiesTest {
	...
	void testReadRevDeadlines() {
		...
		File deleteFile = new File(System.getProperty("user.dir") + File.separator + "projectDB" + File.separator
				+ "editor" + File.separator + "journals" + File.separator + testJournalName + File.separator + "researchers"
				+ File.separator + testingUsername + File.separator + "reviewerDeadlines.txt");
	...
	void testListFilesInDir() {
		...
		String  []filesThatExist = {"researchers", "testingDir" ,"testingDir2"};
	...
	void testReadNomRevFile() {
		File deleteFIle = new File(System.getProperty("user.dir") + File.separator + "projectDB" + File.separator
				+ "editor" + File.separator + "journals" + File.separator + testJournalName + File.separator + "researchers"
				+ File.separator + testingUsername + File.separator + "nominatedReviewers.txt");
	...
	void testCreateUserDir() {
		...
		File deleteFile = new File(System.getProperty("user.dir") + File.separator + "projectDB" + File.separator + "editor"
				+ File.separator + "journals" + File.separator + testJournalName + File.separator + "researchers"
				+ File.separator + User);
